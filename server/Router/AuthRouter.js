...
import { loginvalidate, signupvalidate } from '../Validation/Validator.js';
...
authRouter.route('/Admin/Register').post(validate(signupvalidate), AuthController.AdminRegister);
