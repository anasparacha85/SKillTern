...
const Subscribe = () => {
  return (
    <div className='w-full home-menu h-auto text-center lg:py-14 py-3'>
        ...
        " />
        <span><button className="bg-purple-900 px-4 py-2 rounded-r text-black l">Subscribe</button></span>
